...
Put optional background images here. Recommended default filename per theme:

- `public/skins/backgrounds/light/background.jpg`
- `public/skins/backgrounds/windows95/background.jpg`
- `public/skins/backgrounds/slate/background.jpg`
