...
import { useStudios } from '@/hooks/api/use-studios';
...
export function StudiosPageClient({ isAdmin }: StudiosPageClientProps) {
  const { data: studios, isLoading } = useStudios();

  if (isLoading || !studios) return <StudiosSkeleton />;
