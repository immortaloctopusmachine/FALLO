...
export async function GET(
  ...
  try {
    ...
    const linkedListIds = board.timelineBlocks
      .map((block) => block.listId)
    ...
    console.error('Failed to fetch timeline project:', error);
    return ApiErrors.internal('Failed to fetch timeline project');
  }
}
